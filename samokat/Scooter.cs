namespace samokat
{
    internal class Scooter
    {
        ...
        internal string Number { get => _number; }
        internal double Charge { get => _charge; }
        private int Type { get => _type; }
        internal int Costs { get => _costs; }
        internal double Speed { get => _speed; }
        internal int Index { get => _index; }
